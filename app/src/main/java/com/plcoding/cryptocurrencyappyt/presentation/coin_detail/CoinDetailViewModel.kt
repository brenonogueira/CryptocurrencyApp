...
class CoinDetailViewModel @Inject constructor(
    ...
    savedStateHandle: SavedStateHandle //contains information about the saved state to use normally/ contains navigation parameter
): ViewModel() {
    ...
    private fun getCoin(coinId: String) {
        ...
        }.launchIn(viewModelScope) //launch in corountine
    }
}